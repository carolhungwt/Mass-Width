...
void dosomething(TString chan ="2e2mu",unsigned int iCat =0,bool onshell=false){
	...
	gStyle->SetOptStat(0);
double dcbPara_2e2mu_2nd[6][5][3]={ // [parameter type][category][quadratic coef]
   { {1.0393,0,0}, {1.0290,0,0}, {1.0995,0,0}, {1.1201,0,0},{0.99266,0,0} },
    { {1.9853,0,0}, {1.9142,0,0}, {2.1724,0,0},{2.2146,0,0},{1.8040,0,0} },
    { {-0.278303,0,0}, {-0.288131,0,0}, {-0.318843,0,0},{-0.518080,0,0},{-0.665248,0,0} },
    { {2.8990,0,0}, {2.9640,0,0}, {2.8208,0,0}, {3.2046,0,0}, {3.7292,0,0}},
    { {2.0511,0,0}, {2.3671,0,0}, {1.9475,0,0}, {2.0265,0,0}, {3.3596,0,0} },
    { {1.3253,0,0}, {1.2744,0,0}, {1.4078,0,0}, {1.8544,0,0}, {2.3683,0,0} }
  };
  double dcbPara_4mu_2nd[6][5][3]=
  {
   { {1.2907,0,0}, {1.2178,0,0}, {1.2160,0,0}, {1.4485,0,0},{1.3923,0,0} },
    { {2.4215,0,0}, {1.8319,0,0}, {2.1275,0,0},{2.3574,0,0},{1.9856,0,0} },
    { {-0.220875,0,0}, {-0.194035,0,0}, {-0.175746,0,0},{-0.216012,0,0},{-0.277453,0,0} },
    { {2.0383,0,0}, {1.9011,0,0}, {2.2177,0,0}, {1.6475,0,0}, {2.2740,0,0}},
    { {1.2502,0,0}, {3.0831,0,0}, {1.7967,0,0}, {1.8948,0,0}, {3.0859,0,0} },
    { {1.1313,0,0}, {1.0082,0,0}, {1.0408,0,0}, {1.1783,0,0}, {1.5588,0,0} }
  };
  double dcbPara_4e_2nd[6][5][3]=
  {
    { {0.98829,0,0}, {0.94727,0,0}, {0.98318,0,0}, {1.0200,0,0},{0.95655,0,0} },
    { {1.8944,0,0}, {1.9930,0,0}, {2.0386,0,0},{2.0195,0,0},{1.4504,0,0} },
    { {-0.411268,0,0}, {-0.332637,0,0}, {-0.590996,0,0},{-0.858783,0,0},{-1.10217,0,0} },
    { {3.4845,0,0}, {4.0049,0,0}, {4.0446,0,0}, {5.00,0,0}, {4.5081,0,0}},
    { {2.6403,0,0}, {2.3158,0,0}, {2.7643,0,0}, {3.1343,0,0}, {6.7496,0,0} },
    { {1.5782,0,0}, {1.5478,0,0}, {1.9264,0,0}, {2.3902,0,0}, {2.8741,0,0} }
  };
