...
//******************* qqzz and Template **************************
    ...
    RooKeysPdf qqzzkeyspdf("qqzz_keyspdf","",*mreco,bkgdata,RooKeysPdf::MirrorBoth,rho);
    RooDataHist qqzzdatahist("qqzz_datahist","qqzz_datahist", hist_argset, th2f_qqzz);
    RooHistPdf qqzzhistpdf("qqzz_histpdf","qqzz_histpdf", hist_argset, qqzzdatahist);
    ...
    RooKeysPdf qqzzkeyspdf_up("bkg_qqzz_keyspdf_up","",*mreco,bkgdata_up,RooKeysPdf::MirrorLeft,rho);
    RooDataHist qqzzdatahist_up("qqzz_datahist_up","qqzz_datahist", hist_argset, th2f_qqzz_up);
    RooHistPdf qqzzhistpdf_up("qqzz_histpdf_up","qqzz_histpdf", hist_argset, qqzzdatahist_up);
    ...
    RooKeysPdf qqzzkeyspdf_dn("bkg_qqzz_keyspdf_Down","",*mreco,bkgdata_dn,RooKeysPdf::MirrorLeft);
    RooDataHist qqzzdatahist_dn("qqzz_datahist_dn","qqzz_datahist", hist_argset, th2f_qqzz_dn);
    RooHistPdf qqzzhistpdf_dn("qqzz_histpdf_dn","qqzz_histpdf", hist_argset, qqzzdatahist_dn);
...
//********************* ZX and Template ***************************
			...
			RooDataHist zxdatahist("zx_datahist", "", hist_argset, th2f_zx);
			RooHistPdf zxhistpdf("zx_histpdf","", hist_argset, zxdatahist);
			RooGenericPdf * zjetpdf_generic = new RooGenericPdf("bkg_zjet_generic","bkg_zjet_generic",form,*parlist_zx);
			RooProdPdf *zjetpdf = new RooProdPdf("bkg_zjet","", *zjetpdf_generic, Conditional(zxhistpdf, *dbkg_kin));
